...
system :mac_bench do
    ...
    # ニューラルネットワークの出力のメモリ
    mem_file(typ, 1, clk, rst, rinc: :rst, winc: :rst, anum: :rst).(:channel_a0)
    ...
    a0 = [accessor_a0.wrap(0)]
  
    # 出力層の計算
    output_layer(typ, reader_x, a0).(:layer_output).(clk, rst, fill, req, ack_0)
...
system :output_layer do |typ, reader_x, a0|
